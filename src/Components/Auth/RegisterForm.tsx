...
const RegisterForm = () => {
  ...
  const onSubmit: SubmitHandler<IUser> = async (data) => {
    ...
    try {
      const imageFile = data.image?.[0] as File | undefined;
      ...
      <div className="card bg-base-100 border border-base-300 shadow-2xl">
        <div className="card-body p-8 gap-0">
          ...
          <p className="text-sm text-neutral mb-6">
            Join our growing community of tech lovers
          </p>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <fieldset className="fieldset mb-4">
              ...
              <label
                className={`input input-bordered w-full flex items-center gap-2 transition-all ${errors.name ? "input-error" : "focus-within:input-primary"}`}
              >
                <svg
            ...
            <fieldset className="fieldset mb-4">
              ...
              <label
                className={`input input-bordered w-full flex items-center gap-2 transition-all ${errors.email ? "input-error" : "focus-within:input-primary"}`}
              >
                <svg
                  className="w-4 h-4 text-neutral shrink-0"
                  fill="none"
