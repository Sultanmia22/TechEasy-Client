"use client";
import { IAllProductsClientProps} from "@/types/products.interface";
    ...
    <div>
      ...
      <div className=" pt-10 pb-6 text-center md:text-left">
        ...
        <p className="mt-2 text-neutral max-w-xl">
          Browse our latest tech products including phones, laptops, watches,
          and accessories.
        </p>
      </div>
      ...
      <div className=" pb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full">
          ...
          <select
            ...
            className="border rounded-xl px-4 py-3 bg-base-100"
          >
