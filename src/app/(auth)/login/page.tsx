  ...
  return (
    <main className="min-h-screen bg-base-200 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden>
        ...
        <div className="absolute -top-52 -left-52 w-125 h-125 rounded-full bg-primary/10 blur-[100px]" />
        <div className="absolute -bottom-52 -right-52 w-125 h-125 rounded-full bg-accent/10 blur-[100px]" />
      </div>
